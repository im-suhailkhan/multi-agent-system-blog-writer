...
Requirements:
    pip install langgraph langchain_community langchain-tavily \
                langchain_experimental langchain_groq
...
Recommended Groq models (good tool-calling support):
